...
class Kunden_einwilligung_argument implements RequestInterface
{
     ...
     * @return Kunden_einwilligung_argument
     */
    ...
    /**
     * @param bool $verarbeitung
     * @return Kunden_einwilligung_argument
     */
    public function withVerarbeitung($verarbeitung)
    {
        $new = clone $this;
        $new->verarbeitung = $verarbeitung;
     ...
     * @return bool
     */
    public function getUebermittlung()
    {
        return $this->uebermittlung;
    }

    /**
     * @param bool $uebermittlung
     * @return Kunden_einwilligung_argument
     */
    public function withUebermittlung($uebermittlung)
    {
        $new = clone $this;
        $new->uebermittlung = $uebermittlung;
